...
<head>
    ...
    <script>
        ...
        function updata1() {
            ...
            $.ajax({
                url: "/platformDriver/Updataimage",
                data: formData,
                type: "POST",
                processData: false,
                contentType: false,
...
<div style="width: 1300px; height: 800px; border:1px solid rgba(0,0,0,0.6); float: left; margin: 50px 0px 0px 60px; box-shadow: 0 0 8px black;">
    <h3 style="margin-bottom: 40px">轮播图详情</h3>
    <div style="margin: 40px; margin-top: 94px; box-shadow: 0 0 4px black; height: 620px; padding: 25px 50px 0 50px; text-align: left;" id="temp1">
        <form id="temp6" enctype="multipart/form-data" type="post" >
            <table style="float:left;">
                <input type="hidden" value="${IMG.commodityImgId}" name="commodityImgId">
                <tr>
                    <td><span>图片名称：</span></td>
                    <td><input type="text" value="${IMG.commodityImgDesc}" class="form-control" disabled name="commodityImgDesc"></td>
                </tr>
                <tr>
                    <td><span>创建时间：</span></td>
                    <td><input type="text" value="${IMG.commodityImgLastupdateTime}" id="time" class="form-control date_1" disabled ></td>
                </tr>
                <tr>
                    <td><span>图片排序：</span></td>
                    <td><input type="text" value="${IMG.commodityImgSort}" class="form-control date_1" disabled name="commodityImgSort"></td>
                </tr>
                <tr>
                    <td><span>图片状态：</span></td>
                    <td><input type="text" value="${IMG.commodityImgStatus}" class="form-control date_1" disabled name="commodityImgStatus"></td>
                </tr>
            </table>
                ...
                <div class="article">
                    <div class="item" style="float:left;margin-left: 30px">
                        <label for="businessLicenseTemp" class="btn btn-default addImg ">
                            <img src="${IMG.commodityImgUrl}" width="200px" height="200px">
                        </label>
