...
public class AliyunOSSUtil {
    private static final org.slf4j.Logger logger = LoggerFactory.getLogger(spring.aoyo_hou.utils.AliyunOSSUtil.class);
    ...
    public static String upload(File file){
        ...
        try {
            ...
            //创建文件路径..
            String fileUrl = "devil/image/"+(UUID.randomUUID().toString().replace("-","")+"-"+file.getName());
            //上传文件
